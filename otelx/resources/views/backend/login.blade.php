...
<head>
    ...
    <script src="{{asset('backend')}}/https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
</head>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <form class="user" method="post" action="{{url('/panel/login')}}">
                                    @csrf
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                        <a class="btn btn-primary" href="{{url('/panel')}}">Login</a>
                                    </div>
                                </form>
                                @if($errors->any())
